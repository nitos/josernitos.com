	...
	class com.quasimondo.display.BitmapExporter 
	{
		...
		public  static var gatewayURL:String           = "http://eldomo.net/image/BitmapExporter.php";
		...
		private function onDropImageHandle( success:Boolean ):Void
		{
			...
			if( !fileRef.download( "http://eldomo.net/image/BitmapExporter.php?mode=download&name=071119aac0a44efffdfeed16fd01c1b5.jpg" ), "filename" ) ) 
			{
				error( "[onSave] Dialog box failed to open." );
			}
